...
const images = {
  ...
  portrait: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/749714053_18017948759884732_2203298396947157402_n-mpXfzjYwfUMVq5D2Z9AVTkmxnfX4Uz.jpg',
  street: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/785945131_18023466974884732_6710204539973344964_n-CTRgad7QFD3Wv9RnYjz8mUZ9CQb5SX.jpg',
  ...
  seated: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-08-25%20at%2017.10.54%20%281%29-4YGWWP6weJqeUrkaO3FqNriZk6X2V1.jpeg',
...
export default function Page() {
  ...
  return (
    <main className="campaign-shell">
      <header className="site-header"><a className="brand" href="#inicio" aria-label="Ir para o início"><img className="brand-logo" src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-nCPs1IyWTF1btYT10wjNw9gnYOy1yT.png" alt="Dr. Marcos Adriano Deputado Estadual 12999" /></a><button className="menu-button" onClick={() => setMenuOpen(!menuOpen)} aria-expanded={menuOpen} aria-label={menuOpen ? 'Fechar menu' : 'Abrir menu'}>{menuOpen ? <X /> : <Menu />}</button><nav className={menuOpen ? 'main-nav is-open' : 'main-nav'}><a href="#historia" onClick={closeMenu}>História</a><a href="#linha-do-tempo" onClick={closeMenu}>Trajetória</a><a href="#bandeiras" onClick={closeMenu}>Bandeiras</a><a className="nav-cta" href="#apoie" onClick={closeMenu}>Faça parte <ArrowUpRight data-icon="inline-end" /></a></nav></header>

      <section id="inicio" className="hero-section reveal-section"><div className="hero-grid-lines" aria-hidden="true" /><div className="hero-copy reveal"><p className="eyebrow">PDT · Deputado estadual · Bahia</p><h1>Uma história<br /><em>que não para.</em></h1><p className="hero-lede">Do Guarani para toda a Bahia. Uma trajetória feita de trabalho, escuta e compromisso com o que realmente importa.</p><div className="hero-actions"><a href="#historia" className="button button-yellow">Conheça a história <ArrowDown data-icon="inline-end" /></a><a href="#apoie" className="text-link">Aproxime-se</a></div></div><div className="hero-visual reveal"><div className="hero-sun" /><div className="hero-green" /><img src={images.hero} alt="Marcos Adriano sorrindo com terno azul-marinho" /><div className="hero-tag">DR.<br /><strong>MARCOS</strong><br /><small>ADRIANO</small></div></div><div className="hero-number"><small>número</small><strong>12999</strong></div><div className="hero-ribbon" aria-label="Trabalho que aproxima. Conquista merece mais. Número 12999."><div className="hero-ribbon-track"><span>TRABALHO QUE APROXIMA&nbsp;&nbsp;×&nbsp;&nbsp; CONQUISTA MERECE MAIS&nbsp;&nbsp;×&nbsp;&nbsp; 12999&nbsp;&nbsp;×&nbsp;&nbsp;</span><span aria-hidden="true">TRABALHO QUE APROXIMA&nbsp;&nbsp;×&nbsp;&nbsp; CONQUISTA MERECE MAIS&nbsp;&nbsp;×&nbsp;&nbsp; 12999&nbsp;&nbsp;×&nbsp;&nbsp;</span></div></div></section>
      ...
      <section className="manifesto-section reveal-section"><div className="manifesto-copy"><div className="section-kicker light">04 / compromisso</div><h2>Conquista<br /><span>merece mais.</span></h2><p>Mais planejamento. Mais transparência. Mais coragem para colocar as prioridades certas no centro.</p><a className="button button-outline" href="#apoie">Vamos construir <ArrowUpRight data-icon="inline-end" /></a></div><div className="manifesto-image"><img src={images.yellow} alt="Marcos Adriano em visita à comunidade" /><div className="image-stamp">TRABALHO<br />QUE APROXIMA</div></div></section>

      <section id="apoie" className="support-section section-wrap reveal-section"><div className="support-copy"><div className="section-kicker">05 / perto é melhor</div><h2>Essa história<br /><span>também é sua.</span></h2><p>Receba novidades, participe das conversas e ajude a construir uma representação que começa ouvindo.</p></div><form className="support-form" onSubmit={(event) => { event.preventDefault(); setSubmitted(true) }}>{submitted ? <div className="success-message"><strong>Você chegou junto.</strong><p>Cadastro recebido. Obrigado por fazer parte.</p><button type="button" className="text-link" onClick={() => setSubmitted(false)}>Cadastrar outra pessoa <ArrowUpRight data-icon="inline-end" /></button></div> : <><label htmlFor="name">Seu nome</label><input id="name" required placeholder="Como podemos chamar você?" /><label htmlFor="email">Seu melhor e-mail</label><input id="email" type="email" required placeholder="voce@exemplo.com" /><button className="button button-blue" type="submit">Quero fazer parte <ArrowUpRight data-icon="inline-end" /></button><small>Os dizeres legais e dados do comitê devem ser revisados pela equipe jurídica antes da publicação.</small></>}</form></section>
